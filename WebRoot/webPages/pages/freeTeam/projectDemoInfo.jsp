	...
	<div class="row">
		<div class="col-xs-12">
			<div style="word-break: break-all;">
				<img class="fLeft img-rounded" style="margin-left: -10px;margin-right: 10px;" alt="${pd.title }" width="100px" height="100px" src="${pd.logo}" onerror='this.src="webPages/images/project.jpg"'>
				${pd.depict}
			</div>
		</div>
	</div>
