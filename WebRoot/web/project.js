	...
	function showList(data){
		...
		var str="";
       	for(var i=0; i<data.length; i++)
 	    {
   			...
   			var folderStr = '<div class="filepath pull-left nowrap ellipsis" style="width: 90%; font-size: 12px; color: gray; margin-top: 5px; margin-left: 12px;">::' + node.path +'</div>'
