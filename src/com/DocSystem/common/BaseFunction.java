...
public class BaseFunction{	
	...
	public SystemLDAPConfig getSystemLdapConfig(String systemLdapConfigStr) 
	{
	...
	protected Integer getLdapAuthMode(JSONObject ldapSettings) {
		if(ldapSettings == null)
		{
			return 0;	//默认不进行密码验证
		}
	...
	public List<SearchResult> searchInLdap(LdapContext ctx, LDAPConfig ldapConfig, String userName)
	{
