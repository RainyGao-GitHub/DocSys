...
{  
    ...
    {  
        ...
        String file1Content1 = "abc efg hijk lmn cccc 国家";
        ...
        try {
        	...
        	//List<String> list = LuceneUtil2.fuzzySearch("国家","doc");
        	List<String> list = LuceneUtil2.fuzzySearch("dddRa","doc");
        	//List<String> list = LuceneUtil2.search("dddRa","doc");
        	//List<String> list = LuceneUtil2.Search("8","doc");
        	...
        	LuceneUtil2.deleteIndex("2-0","doc");
           	...
           	list = LuceneUtil2.search("Rain","doc");
        	System.out.println("Search Result count " + list.size());
        	for(int i=0; i < list.size(); i++)
        	{
        		System.out.println(list.get(i));
