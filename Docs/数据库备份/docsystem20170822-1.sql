...
CREATE TABLE IF NOT EXISTS `doc_auth` (
  ...
  `ACCESS` int(2) NOT NULL COMMENT '0:不可见  1:只读',
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `TYPE` int(1) NOT NULL COMMENT '账户类型：保留',
...
(889, 'AppController.java', 1, '#AppController.java', '/', 0, 17, ''),
(890, 'create.jsp', 1, '#create.jsp', '/', 0, 17, ''),
(891, 'XHR——XMLHttpRequest对象 - gaojun - 博客园.pdf', 1, '#XHR——XMLHttpRequest对象 - gaojun - 博客园.pdf', '/', 0, 17, ''),
(892, '新建仓库', 1, '#新建仓库\n\n仓库新建时没有新建目录', '/BUGList/', 546, 7, ''),
(893, '122223', 1, '#122223\n\nd\nd\nd\nd\nd\nd', '/', 0, 16, ''),
(894, '11222', 1, '#11222', '/122223', 893, 16, ''),
(895, 'HP_LJ_M605_PCL6_Print_Driver_no_Installer_15187.exe', 1, '#HP_LJ_M605_PCL6_Print_Driver_no_Installer_15187.exe', '/', 0, 17, NULL);
...
CREATE TABLE IF NOT EXISTS `wiki_project` (
  ...
  `SVN_PATH` varchar(200) NOT NULL,
  `SVN_USER` varchar(50) NOT NULL,
  `SVN_PWD` varchar(20) NOT NULL,
