...
INSERT INTO `wiki_doc` (`id`, `name`, `type`, `content`, `path`, `pid`, `vid`) VALUES
...
INSERT INTO `wiki_project` (`id`, `name`, `type`, `path`, `info`, `menu`, `edit_time`) VALUES
