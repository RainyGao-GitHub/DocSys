...
(1426, '博朗软件', 2, '#博朗软件', '/', 0, 40, NULL),
(1427, 'bleum_trans_small_165x60.png', 1, '#bleum_trans_small_165x60.png', '/博朗软件/', 1426, 40, NULL),
(1428, 'logo.png', 1, '#logo.png', '/博朗软件/', 1426, 40, NULL),
(1429, '博朗软件.png', 1, '#博朗软件.png', '/博朗软件/', 1426, 40, NULL),
(1430, '博彦科技', 2, '#博彦科技', '/', 0, 40, NULL),
(1431, 'logo-cn.jpg', 1, '#logo-cn.jpg', '/博彦科技/', 1430, 40, NULL),
(1432, '1122', 1, '#1122', '/', 0, 40, NULL),
(1433, '3333', 2, '#3333', '/', 0, 40, NULL),
(1434, '.classpath', 1, '#.classpath', '/', 0, 40, NULL);
...
INSERT INTO `wiki_project` (`ID`, `NAME`, `TYPE`, `PATH`, `SVN_PATH`, `SVN_USER`, `SVN_PWD`, `INFO`, `MENU`, `PWD`, `OWNER`, `CREATE_TIME`) VALUES
